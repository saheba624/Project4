            ...
            <table width="100%">
                <tr>
                   ...
                   <%--  <label>Email_Id:</label>
                    ...
                    --%> 
                   <% List collegeList =(List)request.getAttribute("clist");%>
					<label>College Name :</label>
					<%= HTMLUtility.getList("collegeId",String.valueOf(ServletUtility.getParameter("collegeId", request)),collegeList)%> 
