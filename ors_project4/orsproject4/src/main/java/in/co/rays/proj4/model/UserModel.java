...
public class UserModel {
    ...
    {
    	System.out.println("UserModel Add method started");
...
System.out.println("Usermodel Add method End");
return pk;
}
    ...
    {
    	System.out.println("usermodel delete method started");
    	Connection conn = null;
    	try 
    	{
		conn=JDBCDataSource.getConnection();
  ...
  {
	  System.out.println("usermodel Findbypk started");
  ...
  {
	  System.out.println(" usermodel Update method started");
	  Connection conn=null;
  ...
  public List search(UserBean bean) throws ApplicationException {
	  System.out.println("usermodel Search method started");
  ...
  public List search(UserBean bean,int pageNo,int pageSize) throws ApplicationException
  {
	  ...
	  log.debug("usermodel Model list search Started");
      ...
      System.out.println("usermodel list search end");
      return list;
...
public List list(int pageNo,int pageSize) throws ApplicationException
{
	...
	JDBCDataSource.closeConnection(conn);	
	  ...
	  System.out.println("Usermodel list End");
	return list;
}
...
{
	System.out.println("usermodel authenticate method started");
...
public long registerUser(UserBean bean)throws ApplicationException,DuplicateRecordException, DatabaseException
{
	...
	System.out.println("USermodel registerUser method Start");
	long pk = add(bean);
   ...
   String message = EmailBuilder.getUserRegistrationMessage(map);
    ...
    System.out.println("Usermodel registerUser method End");
    return pk;
...
{
	System.out.println("Usermodel reset password started");
...
{
	System.out.println("Usermodel forgetpassword started");
