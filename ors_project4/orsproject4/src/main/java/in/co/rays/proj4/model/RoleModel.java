...
public class RoleModel {
    ...
    public Integer nextPK() throws DatabaseException {
        ...
        System.out.println("Role model nextpk strated");
        ...
        System.out.println("role model nextpk end");
        return pk + 1;
    }
    ...
    public long add(RoleBean bean) throws ApplicationException,
        ...
        System.out.println("Role model add started");
        Connection conn = null;
        int pk = 0;
        ...
        System.out.println("role model add end");
        return pk;
    }
    ...
    public void delete(RoleBean bean) throws ApplicationException {
        ...
        System.out.println("role model delete started");
        Connection conn = null;
        try {
            conn = JDBCDataSource.getConnection();
            conn.setAutoCommit(false); // Begin transaction
        ...
        System.out.println("role model delete end");
    }
    ...
    public RoleBean findByName(String name) throws ApplicationException {
        ...
        System.out.println("role model findby emailid started");
        ...
        System.out.println("role model find by emailid end");
        return bean;
    }
    ...
    public RoleBean findByPK(long pk) throws ApplicationException {
        ...
        System.out.println("role model find by pk started");
        ...
        System.out.println("role model findbypk end");
        return bean;
    }
    ...
    public void update(RoleBean bean) throws ApplicationException,
        ...
        System.out.println("role model update started");
        Connection conn = null;
        ...
        System.out.println("role model update end");
    }
    ...
    public List search(RoleBean bean, int pageNo, int pageSize)
        ...
        System.out.println("role model search started");
        ...
        System.out.println("role model search end");
        return list;
    }
    ...
    public List list(int pageNo, int pageSize) throws ApplicationException {
        ...
        System.out.println("role model list started");
        ArrayList list = new ArrayList();
        ...
        System.out.println("role model list end");
        return list;
