...
public class SubjectModel {
	...
	public long add(SubjectBean bean) throws ApplicationException, DuplicateRecordException {
		...
		System.out.println(" subject model add method end");
		return pk;
	}
	...
	public void delete(SubjectBean bean) throws ApplicationException {
		...
		System.out.println("Subject model delete started");
		Connection conn = null;
		try {
			conn = JDBCDataSource.getConnection();
			conn.setAutoCommit(false); // Begin transaction
	...
	public SubjectBean findByName(String name) throws ApplicationException {
		...
		System.out.println("subject model find by emailId started");
		...
		System.out.println("subject model find by Emailid End");
		return bean;
	}
	...
	public SubjectBean findByPK(long pk) throws ApplicationException {
		...
		System.out.println("subject model find by pk strated");
		...
		System.out.println("subject model findby pk end");
		return bean;
	}
	...
	public void update(SubjectBean bean) throws ApplicationException, DuplicateRecordException {
		...
		System.out.println("subject model update strted");
		Connection conn = null;
		...
		System.out.println("subject model update end");
	}
	...
	public List search(SubjectBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("subject model search strated");
		...
		System.out.println("subject model search end");
		return list;
	}
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("subject model list started");
		ArrayList list = new ArrayList();
		...
		System.out.println("subject model list end");
		return list;
