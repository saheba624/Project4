...
public class FacultyModel {
	...
	public Integer nextPK() throws DatabaseException {
	    ...
	    System.out.println("faculty model nextpk started");
	    ...
	    System.out.println("faculty model nextpk end");
	    return pk + 1;
	}
	...
	public long add(FacultyBean bean) throws ApplicationException,
	    ...
	    System.out.println("faculty model add started");
	    Connection conn = null;
	  ...
	  //get subject name
	    ...
	    System.out.println("faculty model add end");
	    return pk;
	}
	...
	public void delete(FacultyBean bean) throws ApplicationException {
	    ...
	    System.out.println("faculty model delete started");
	    Connection conn = null;
	    try {
	        conn = JDBCDataSource.getConnection();
	        conn.setAutoCommit(false); // Begin transaction
	    ...
	    System.out.println("faculty model delete end");
	}
	...
	public FacultyBean findByEmailId(String Email) throws ApplicationException {
	    ...
	    System.out.println("faculty model findby email started");
	    ...
	    System.out.println("faculty model findby email end");
	    return bean;
	}
	...
	public FacultyBean findByPK(long pk) throws ApplicationException {
	    ...
	    System.out.println("faculty model findbypk started");
	    ...
	    System.out.println("faculty model findbypk end");
	    return bean;
	}
	...
	public void update(FacultyBean bean) throws ApplicationException,
	        DuplicateRecordException {
		System.out.println("faculty model update started");
	  ...
	  //get subject name
	    ...
	    System.out.println("faculty model update end");
	}
	...
	public List search(FacultyBean bean, int pageNo, int pageSize)
	    ...
	    System.out.println("faculty model search started");
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
	    ...
	    System.out.println("faculty model list started");
	    ArrayList list = new ArrayList();
	    ...
	    System.out.println("faculty model list end");
	    return list;
