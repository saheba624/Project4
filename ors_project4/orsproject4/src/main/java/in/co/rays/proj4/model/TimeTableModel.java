...
public class TimeTableModel {
    ...
    public Integer nextPK() throws DatabaseException {
        ...
        System.out.println("timtable model next pk started");
        ...
        System.out.println("timetable model next pk end ");
        return pk + 1;
    }
    ...
    public long add(TimeTableBean bean) throws ApplicationException, DuplicateRecordException {
        ...
        System.out.println("timetable add started");
        Connection conn = null;
        ...
        System.out.println("timetable model add end");
        return pk;
    }
    ...
    public void delete(TimeTableBean bean) throws ApplicationException {
        ...
        System.out.println("timetable model delete started");
        Connection conn = null;
        try {
            conn = JDBCDataSource.getConnection();
            conn.setAutoCommit(false); // Begin transaction
        ...
        System.out.println("timetable model delete end");
    }
    ...
    public TimeTableBean findByPK(long pk) throws ApplicationException {
        ...
        System.out.println("timetable model findpk started");
        ...
        System.out.println("timetable model findpk end");
        return bean;
    }
    /**
    ...
    public TimeTableBean findByCouSubSem(long CourseId,String Semester, long SubjectId) throws ApplicationException {
        ...
        System.out.println("timetable Model findByCourSubSem Started");
        ...
        log.debug("Model findByPK End");
        System.out.println("timetable Model findByPK End");
        return bean;
    }
    /**
    ...
    public TimeTableBean findByDateCouSem(Date examdate,long CourseId, String Semester) throws ApplicationException {
        ...
        System.out.println("timetable Model findByDateCouSem Started");
        ...
        System.out.println("timetable Model findByDateCouSem end");
        return bean;
    }
...
System.out.println("timetable model update started");
Connection conn = null;
...
System.out.println("timetable model update end");
}
    ...
    public List search(TimeTableBean bean, int pageNo, int pageSize) throws ApplicationException {
        ...
        System.out.println("timetable model search started");
        ...
        System.out.println("timetable model search end");
        return list;
    }
    ...
    public List list(int pageNo, int pageSize) throws ApplicationException {
        ...
        System.out.println("timetable model list started");
        ArrayList list = new ArrayList();
        ...
        System.out.println("timetable model list end");
        return list;
