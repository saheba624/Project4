...
public class MarksheetModel {
		...
		public Integer nextPK() throws DatabaseException{
			...
			System.out.println("marksheet model next pk started");
			...
			System.out.println("marksheet model nextpk end");
			return pk+1;
	 ...
	 System.out.println("marksheet model add started");
	 ...
	 System.out.println("marksheet model add end");
	 return pk;
	}
	...
	*/
	public void delete(MarksheetBean bean) throws ApplicationException {
	 ...
	 System.out.println("marksheet model delete started");
	 ...
	 System.out.println("marksheet model delete end");
	}
	...
	*/
	...
	public MarksheetBean findByRollNo(String rollNo)
	 ...
	 System.out.println("marksheet model findby roll started");
	 ...
	 System.out.println("marksheet model findbyrollno end");
	 return bean;
	}
	...
	*/
	...
	public MarksheetBean findByPK(long pk) throws ApplicationException {
	 ...
	 System.out.println("marksheet model find by pk started");
	 ...
	 System.out.println("marksheet model findbypk end");
	 return bean;
	}
	...
	*/
	...
	public void update(MarksheetBean bean) throws ApplicationException,
	 ...
	 System.out.println("marksheet model update started");
	 ...
	 System.out.println("marksheet model update end");
	...
	*/
	...
	public List search(MarksheetBean bean, int pageNo, int pageSize)
	 ...
	 System.out.println("marksheet model search started");
	 ...
	 System.out.println("marksheet model search end");
	 return list;
	}
	...
	*/
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
	 ...
	 System.err.println("marksheet model list started");
	...
	*/
	...
	public List getMeritList(int pageNo, int pageSize)
	 ...
	 System.out.println("marksheet model meritlist end");
	 return list;
	}
