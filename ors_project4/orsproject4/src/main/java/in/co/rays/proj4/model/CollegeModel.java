...
public class CollegeModel {
    ...
    public Integer nextPK() throws DatabaseException {
        ...
        System.out.println("college model nextpk started");
        ...
        System.out.println("college model nextpk end ");
        return pk + 1;
    }
    ...
    public long add(CollegeBean bean) throws ApplicationException,
        ...
        System.out.println("college model add started");
        Connection conn = null;
        int pk = 0;
        ...
        System.out.println("college model add end ");
        return pk;
    }
    ...
    public void delete(CollegeBean bean) throws ApplicationException {
        ...
        System.out.println("college model delete started");
        Connection conn = null;
        try {
            conn = JDBCDataSource.getConnection();
            conn.setAutoCommit(false); // Begin transaction
        ...
        System.out.println("college model delete end");
    }
    ...
    public CollegeBean findByName(String name) throws ApplicationException {
        ...
        System.out.println("college model findby started");
        ...
        System.out.println("college model find by pk end");
        return bean;
    }
